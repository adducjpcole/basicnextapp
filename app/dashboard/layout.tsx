      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        <header className="bg-blue-600 shadow px-6 py-2 flex items-center justify-between text-white">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/dashboard/uom"
              className="text-xs font-semibold uppercase tracking-widest rounded hover:bg-white hover:text-blue-600 px-4 py-2 transition-colors"
            >
              Units
            </Link>
            <Link
              href="/dashboard/testcategories"
              className="text-xs font-semibold uppercase tracking-widest rounded hover:bg-white hover:text-blue-600 px-4 py-2 transition-colors"
            >
              Categories
            </Link>
            <Link
              href="/dashboard/medicaltests"
              className="text-xs font-semibold uppercase tracking-widest rounded hover:bg-white hover:text-blue-600 px-4 py-2 transition-colors"
            >
              Tests
            </Link>
